                  ...
                  <div className="flex items-center gap-3 mb-2">
                   ...
                   <div className="text-sm text-gray-600 space-y-1">
                     ...
                     {venda.data_assinatura_contrato && (
                       <p><strong>Data de Assinatura do Contrato:</strong> <span className="text-blue-600 font-semibold">{new Date(venda.data_assinatura_contrato).toLocaleDateString('pt-BR')}</span></p>
                     )}
                   </div>
                </div>
              ))}
