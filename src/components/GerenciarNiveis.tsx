...
const GerenciarNiveis: React.FC = () => {
  ...
  const handleSaveNivel = async (e: React.FormEvent) => {
    ...
    if (editingNivel.tipo_usuario === 'sdr') {
      dados.meta_semanal_sdr = parseInt(formData.get('meta_semanal_sdr') as string);
          ...
          <div>
            ...
            {nivel.tipo_usuario === 'sdr' ? (
              <div className="space-y-1">
                <p className="text-sm font-medium">Reuniões: {nivel.meta_semanal_sdr} por semana</p>
                ...
                <>
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      defaultValue={editingNivel.meta_semanal_sdr}
                      required
                    />
                  </div>
                  <div>
