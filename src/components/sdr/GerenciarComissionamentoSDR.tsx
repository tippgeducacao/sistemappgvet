  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Regras de Comissionamento - SDRs</h2>
          <p className="text-muted-foreground">
            Configure os multiplicadores baseados no percentual de atingimento da meta de reuniões
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>• O sistema calcula o percentual de atingimento da meta com base nas reuniões realizadas</p>
            ...
            <p>• Exemplo: Meta 55 reuniões, realizou 27 (49%) = R$ 450 × 0 = R$ 0</p>
            <p>• Exemplo: Meta 55 reuniões, realizou 55 (100%) = R$ 450 × 1 = R$ 450</p>
          </div>
        </CardContent>
      </Card>
    </div>
