...
('condicoes_parcelamento', '24x', 0),
('condicoes_parcelamento', '30x', -0.1),
('condicoes_parcelamento', '36x', -0.2);

-- Regras para Como chegou o lead (Marketing)
INSERT INTO public.regras_pontuacao (campo_nome, opcao_valor, pontos) VALUES
('como_chegou_lead', 'INDICAÇÃO', 0),
('como_chegou_lead', 'ORGÂNICO', 0),
('como_chegou_lead', 'GOOGLE', 0),
('como_chegou_lead', 'META ADS', 0),
('como_chegou_lead', 'LINKEDIN', 0);

-- Regras para Tipo de Venda
INSERT INTO public.regras_pontuacao (campo_nome, opcao_valor, pontos) VALUES
('tipo_venda', 'REUNIÃO MEET', 0),
('tipo_venda', 'LIGAÇÃO', 0.3),
('tipo_venda', 'LIGAÇÃO E FECHAMENTO NO WHATSAPP', 0),
('tipo_venda', 'WHATSAPP', -0.3),
('tipo_venda', 'LANÇAMENTO ( CAMPANHA )', 0),
('tipo_venda', 'VENDA DIRETA', 0),
('tipo_venda', 'PRESENCIAL', 0),
('tipo_venda', 'EMAIL', 0),
('tipo_venda', 'OUTRO', 0);
